...
<section class="dashboard">
   ...
   <div class="box">
         ...
         ?>
         <h3><span><?= $number_of_orders; ?></span></h3>
         <p>total orders</p>
      ...
      <div class="box">
         ...
         ?>
         <h3><span><?= $number_of_products; ?></span></h3>
         <p>total products</p>
      ...
      <div class="box">
         ...
         ?>
         <h3><span><?= $number_of_users; ?></span></h3>
         <p>normal users</p>
      ...
      <div class="box">
         ...
         ?>
         <h3><span><?= $number_of_admins; ?></span></h3>
         <p>admin users</p>
